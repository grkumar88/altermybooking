  ...
  useEffect(() => {
    const fetchSeats = async () => {
      try {
        ...
        console.log(
          'Flights ==> ',
          JSON.stringify(data?.Response.SeatMapsResponses)
        );
        const newResponse = [
          {
  ...
  return (
    <div className="">
      {seatList?.map((list, index) => {
        ...
        return (
          <>
            <div className="md:flex justify-between p-6 bg-white rounded-xl m-5">
              <div>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm text-[#9f9f9f]">
                      {flightSegment.Equipment.AircraftName}
                    </p>
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    ...
                    <span className="text-[#9f9f9f] text-right block md:hidden">
                      {' '}
                      From{' '}
              ...
              <div className="self-center">
                <div className="flex space-x-2">
                  <span className="text-[#9f9f9f] hidden md:block">
                    {' '}
                    From{' '}
                    <span className="text-black">
                      {' '}
                  ...
                  <button
                    ...
                    className="hidden md:block bg-[#3561FF] text-md px-2 rounded-xl text-[#ffffff] border-solid border border-[#3561FF]"
                  >
                    Select
                  </button>
                </div>
              ...
              <div className="block md:hidden">
                <button
                  onClick={() => toggleSeatOpen(index)}
                  // onClick={() => handleSeatSelect('outbound')}
                  className="bg-[#3561FF] text-md px-2 rounded-xl text-[#ffffff] border-solid border border-[#3561FF] w-full p-2 mt-2"
                >
                  Select
                </button>
              </div>
