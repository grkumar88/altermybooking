...
const BaggageCard: React.FC<{ title: string; description: string; weight: string; price: number }> = ({ title, description, weight, price }) => {
  ...
  return (
    <div className="w-full flex flex-col justify-between max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
      ...
      }} className='border  bg-green-700 text-white uppercase font-bold rounded-xl px-5 py-3 m-4'>Select</button>
    </div>
  );
};
