...
const Meals = (props: Props) => {
    ...
    const handleFilterChange = (type: 'All' | 'Veg' | 'Non Veg') => {
        setFilterType(type);
    };

    const handleAddClick = (mealId: number, mealPrice: string) => {
    ...
    const filteredMeals = meals.filter(meal => filterType === 'All' || meal.type === filterType);
