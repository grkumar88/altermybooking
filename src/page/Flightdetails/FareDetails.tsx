import { selectedseat, basicfare, tax, seatfare, meals,baggage } from '@/redux/flightSlice';
import { useSelector } from 'react-redux';
type Props = {
  classname: string
}
// export default function FareDetails({classname}) {
  const FareDetails = ({classname}: Props) => {
      ...
      <div className="flex ">
        ...
        {/* <div className=" bg-white right-100  inline-block p-4 border rounded w-80"> */}
          <section>
           ...
           { mealsValue!== 0 && <div className=" flex justify-between items-center my-2 border-b border-gray-200 py-2">
              <div className=" pointer flex-2 flex items-center">
                <span className="mr-2  mt-1">
                  <span
                    className="iconPlusImg bg-no-repeat"
